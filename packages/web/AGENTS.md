...
- Live emitted Pico roles: surfaces, primary family, invalid/del. To add secondary/contrast, copy names from https://picocss.com/docs/css-variables into `PICO_LIGHT` — do not comment-dump Pico's full theme.
